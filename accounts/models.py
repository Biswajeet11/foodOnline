...
class UserManager(BaseUserManager):   
    def create_user(self,first_name,last_name,username,email,password=None):
        ...
        #password doesnot store in string which is why doing set_password
        user.set_password(password)
        #takes default data base
    ...
    def create_superuser(self,first_name,last_name,username,email,password=None):
        ...
        user = self.create_user(
            email = self.normalize_email(email), username =username,password=password,first_name=first_name,last_name=last_name
        )
        #then make him super user
        user.is_admin= True
        user.is_active = True
        user.is_staff = True
